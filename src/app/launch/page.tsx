...
export const metadata: Metadata = {
  ...
  description:
    'Launch on the open pons v2 factory with a PonsVault attached — pair against stocks or USDG, choose a fee vault.',
};
        ...
        <div className="pv-shell">
          ...
          <Reveal>
            ...
            <p className="pv-body pv-measure pv-page-lead">
              ...
              creator fees, and sign from your own wallet. For NFT seat series, use{' '}
