...
import {PonsV2StakingVault} from "../vaults/PonsV2StakingVault.sol";

/// @title PonsV2StakingVaultFactory
contract PonsV2StakingVaultFactory is Ownable2Step, IPonsV2VaultFactory {
    ...
    constructor() Ownable2Step() {
        PonsV2StakingVault impl = new PonsV2StakingVault();
        ...
        returns (address vault)
    {
        ...
        PonsV2StakingVault.Config memory decoded = abi.decode(config, (PonsV2StakingVault.Config));

        vault = address(
            new BeaconProxy(
                beacon, abi.encodeCall(PonsV2StakingVault.initialize, (token, quoteAsset, decoded))
            )
        );
